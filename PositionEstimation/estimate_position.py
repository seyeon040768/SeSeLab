...
class Estimator:
    def __init__(self, position: np.ndarray, rotation: np.ndarray, max_speed: float = 100, max_steer: float = 50, max_skidding: float = 1):
        self.position = position
        self.rotation = rotation
        self.skidding = max_skidding / max_speed**2
